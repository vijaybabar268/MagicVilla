...
namespace MagicVilla_VillaAPI.Migrations
{
    ...
    [Migration("20231018040644_AddForeignKeyToVillaTable")]
            ...
            modelBuilder.Entity("MagicVilla_VillaAPI.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 10, 18, 4, 6, 44, 596, DateTimeKind.Utc).AddTicks(6830),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 10, 18, 4, 6, 44, 596, DateTimeKind.Utc).AddTicks(6838),
                            Details = "Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "",
                            CreatedDate = new DateTime(2023, 10, 18, 4, 6, 44, 596, DateTimeKind.Utc).AddTicks(6840),
                            Details = "Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for previewing layouts and visual mockups.",
